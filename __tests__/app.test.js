...
describe('POST form-data to /api/search', () => {
  ...
  it('should return XML', async () => {
    const response = await request(app).post('/api/search').set('Accept', 'application/xml').field('query', 'phone')
      .field('page', '1');
...
describe('POST json to /api/search', () => {
  ...
  it('should return XML', async () => {
    const response = await request(app).post('/api/search').set('Accept', 'application/xml').set('Content-Type', 'application/json')
      .send({ query: 'phone', page: 1 });
...
describe('POST xml to /api/search', () => {
  ...
  it('should return XML', async () => {
    const response = await request(app).post('/api/search').set('Accept', 'application/xml').set('Content-Type', 'application/xml')
      .send('<body><query>phone</query><page>1</page></body>');
